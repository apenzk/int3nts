...
Returns the trusted-gmp public key (base64, 32 bytes).
...
Returns approvals generated by the trusted-gmp service after observing fulfillment + matching escrow.
...
Note: The signature itself is the approval - trusted-gmp signs the `intent_id` to approve the escrow.
...
Note: The signature itself is the approval - trusted-gmp signs the `intent_id`.
