...
//!
//! This module handles all cryptographic operations for the integrated-gmp service,
...
///
/// The signature itself is the approval - integrated-gmp signs the intent_id to approve it.
...
/// Cryptographic service that handles all crypto operations for the integrated-gmp.
///
...
impl CryptoService {
    ...
    ///
    /// The integrated-gmp signs the intent_id to approve it. The signature itself is the approval.
    ...
    ///
    /// The integrated-gmp signs the raw 32-byte intent_id (no BCS encoding).
    ...
    /// of the private key corresponding to the integrated-gmp's public key.
    ///
    /// # Arguments
    ///
    ...
    ///
    /// This function provides access to the integrated-gmp's public key,
