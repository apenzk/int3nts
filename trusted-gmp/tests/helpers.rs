...
use trusted_gmp::validator::FulfillmentTransactionParams;
...
/// Dummy trusted-gmp EVM public key hash (keccak256 hash of ECDSA public key, last 20 bytes; on-chain approver address)
#[allow(dead_code)]
