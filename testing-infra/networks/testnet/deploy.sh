...
[ -n "$MVM_MODULE_ADDR" ] && echo "   NEXT_PUBLIC_MOVEMENT_TESTNET_INTENT_CONTRACT_ADDRESS=$MVM_MODULE_ADDR"
[ -n "$EVM_ESCROW_ADDR" ] && echo "   NEXT_PUBLIC_BASE_TESTNET_ESCROW_CONTRACT_ADDRESS=$EVM_ESCROW_ADDR"
[ -n "$EVM_OUTFLOW_ADDR" ] && echo "   NEXT_PUBLIC_BASE_TESTNET_OUTFLOW_VALIDATOR_ADDRESS=$EVM_OUTFLOW_ADDR"
[ -n "$SVM_ESCROW_ID" ] && echo "   NEXT_PUBLIC_SOLANA_TESTNET_PROGRAM_ID=$SVM_ESCROW_ID"
[ -n "$SVM_OUTFLOW_ID" ] && echo "   NEXT_PUBLIC_SOLANA_TESTNET_OUTFLOW_PROGRAM_ID=$SVM_OUTFLOW_ID"
echo ""
} | tee "$SUMMARY_LOG"
