...
# Start Integrated-GMP for EVM E2E Tests
#
...
setup_project_root
setup_logging "integrated-gmp-start-evm"
cd "$PROJECT_ROOT"
...
source "$PROJECT_ROOT/testing-infra/ci-e2e/chain-connected-evm/configure-integrated-gmp.sh"
