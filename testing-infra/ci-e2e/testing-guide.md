...
# Multi-chain: ./testing-infra/ci-e2e/chain-connected-mvm/setup-requester-solver.sh
# Or chains only: ./testing-infra/ci-e2e/chain-connected-mvm/setup-chain.sh
...
BOB_ADDR=$(aptos config show-profiles | jq -r '.bob.account')
printf "yes\n" | aptos account transfer --profile alice --account ${BOB_ADDR} --amount 2000000 --max-gas 10000
