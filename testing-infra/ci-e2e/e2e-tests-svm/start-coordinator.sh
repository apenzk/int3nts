...
# Start Coordinator for SVM E2E Tests
#
...
setup_project_root
setup_logging "coordinator-start-svm"
cd "$PROJECT_ROOT"
...
source "$PROJECT_ROOT/testing-infra/ci-e2e/chain-connected-svm/configure-coordinator.sh" 2
source "$PROJECT_ROOT/testing-infra/ci-e2e/chain-connected-svm/configure-coordinator.sh" 3
