...
setup_project_root
setup_logging "configure-integrated-gmp-hub"
cd "$PROJECT_ROOT"

log_and_echo "   Configuring integrated-gmp for Hub Chain..."
log_and_echo ""
...
# Generate fresh ephemeral keys for integrated-gmp
...
mkdir -p "$(dirname "$INTEGRATED_GMP_E2E_CI_TESTING_CONFIG")"

# Generate the complete config file from scratch
cat > "$INTEGRATED_GMP_E2E_CI_TESTING_CONFIG" << EOF
# Integrated-GMP E2E Testing Configuration
# Auto-generated by configure-integrated-gmp.sh - DO NOT EDIT MANUALLY
...
log_and_echo "   Created integrated-gmp-e2e-ci-testing.toml with Hub Chain addresses"
log_and_echo ""
