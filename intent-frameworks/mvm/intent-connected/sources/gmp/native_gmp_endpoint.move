/// Native GMP Endpoint (Receiver) - Connected Chain Version
///
/// Handles inbound cross-chain message delivery and routing for connected chains.
/// Routes messages to outflow_validator_impl and inflow_escrow_gmp.
///
/// ## Architecture
///
