...
module mvmt_intent::intent_outflow_validator_tests {
    ...
    fun test_receive_stores_requirements(aptos_framework: &signer, admin: &signer) {
        ...
        assert!(!intent_outflow_validator_impl::is_fulfilled(copy intent_id), 2);
        assert!(intent_outflow_validator_impl::get_amount_required(intent_id) == amount, 3);
    }
    ...
    #[expected_failure(abort_code = 6, location = mvmt_intent::intent_outflow_validator_impl)] // EALREADY_FULFILLED
    fun test_fulfill_intent_rejects_already_fulfilled(
        ...
        intent_outflow_validator_impl::fulfill_intent(solver, copy intent_id, token_metadata);

        // Second fulfillment should fail
        intent_outflow_validator_impl::fulfill_intent(solver, intent_id, token_metadata);
    }
    ...
    #[test(aptos_framework = @0x1, admin = @mvmt_intent, token_creator = @0xABC, solver = @0x456)]
    #[expected_failure(abort_code = 7, location = mvmt_intent::intent_outflow_validator_impl)] // EINTENT_EXPIRED
    ...
    #[test(aptos_framework = @0x1, admin = @mvmt_intent, token_creator = @0xABC, solver = @0x456)]
    #[expected_failure(abort_code = 8, location = mvmt_intent::intent_outflow_validator_impl)] // EUNAUTHORIZED_SOLVER
    ...
    #[test(aptos_framework = @0x1, admin = @mvmt_intent, token_creator = @0xABC, solver = @0x456)]
    #[expected_failure(abort_code = 9, location = mvmt_intent::intent_outflow_validator_impl)] // ETOKEN_MISMATCH
    ...
    #[test(aptos_framework = @0x1, admin = @mvmt_intent, token_creator = @0xABC, solver = @0x456)]
    #[expected_failure(abort_code = 5, location = mvmt_intent::intent_outflow_validator_impl)] // EREQUIREMENTS_NOT_FOUND
    fun test_fulfill_intent_rejects_requirements_not_found(
        ...
        intent_outflow_validator_impl::fulfill_intent(solver, unknown_intent_id, token_metadata);
    }
    ...
    fun test_fulfill_intent_succeeds(
        ...
        assert!(intent_outflow_validator_impl::is_fulfilled(copy intent_id), 3);
